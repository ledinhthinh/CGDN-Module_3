            ...
            <form method="post">
                ...
                <table class="table-sm" >
                    <tr>
                        <th>Customer ID:</th>
                        <td>
                            <input type="text" name="customer_id" id="customer_id" value="${customer.id}" placeholder="KH-0000,KH-1111,..." class="form-control" required/>
                            <p>
                                <c:if test='${message1 != ""}'>
                    ...
                    <tr>
                        <th>Customer Name:</th>
                        <td>
                            <input placeholder="Nguyễn Văn A,..." type="text" name="customer_name" value="${customer.name}" id="customer_name"
                    ...
                    <tr>
                        <th>Customer Address:</th>
                        <td>
                            <input value="${customer.address}" type="text" name="customer_address" id="customer_address" class="form-control" required/>
                        </td>
                    </tr>
                    <tr>
                        <th>Type Customer:</th>
                        <td>
                            ...
                            <select id="customer_type_id" name="customer_type_id" class="form-control">
                                <option value="1" ${customer.customerType.idCustomerType == '1'? 'selected':''}>Diamond</option>
                                <option value="2" ${customer.customerType.idCustomerType == '2'? 'selected':''}>Platinium</option>
                                <option value="3" ${customer.customerType.idCustomerType == '3'? 'selected':''}>Gold</option>
                                <option value="4" ${customer.customerType.idCustomerType == '4'? 'selected':''}>Silver</option>
                                <option value="5" ${customer.customerType.idCustomerType == '5'? 'selected':''}>Member</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
