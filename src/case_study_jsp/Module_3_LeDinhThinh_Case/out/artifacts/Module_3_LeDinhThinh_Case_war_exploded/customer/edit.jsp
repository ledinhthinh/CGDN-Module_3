            ...
            <form method="post">
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>Customer Birthday:</th>
                        <td>
                            <input class="form-control"type="text" name="birthday" size="45"
                                   value="<c:out value='${customer.birthday}' />"
                            />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>Customer Id card:</th>
                        <td>
                            <input class="form-control" type="text" name="id_card" size="45"
                                   value="<c:out value='${customer.id_card}' />"
                            />
                        </td>
                    </tr>
                    <tr>
                        <th>Customer Phone:</th>
                        <td>
                            <input class="form-control" type="text" name="phone" size="45"
                                   value="<c:out value='${customer.phone}' />"
                            />
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <a href="customer?action=customers" class="btn btn-outline-secondary" type="button">Close</a>
