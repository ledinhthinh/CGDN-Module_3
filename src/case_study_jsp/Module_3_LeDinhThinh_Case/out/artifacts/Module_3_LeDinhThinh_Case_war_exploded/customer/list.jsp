...
<div style="position: relative;top: 135px">
    ...
    <div class="card" style="width: 81%; margin-left: 18rem ; height: 115%">
        ...
        <div align="center">
            <caption><h2>List of Customer</h2></caption>
            <table class="table-sm table-striped table-bordered" id="tableCustomer">
                <thead>
                ...
                <c:forEach var="customer" items="${listCus}">
                    <tr>
                        ...
                        <td><c:out value="${customer.getEmail()}"/></td>
                        <td><c:out value="${customer.getAddress()}"/></td>
                        <td><c:out value="${customer.customerType.nameCustomerType}"/></td>
                        <td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a type="button" href="/customer?action=delete&id=${customer.getId()}" class="btn btn-outline-danger">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <br>
            <a href="/customer?action=create" class="btn btn-outline-success btn-sm w-25">Add New Customer</a>
        </div>
